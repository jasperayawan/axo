  ...
  return (
    <main className="flex flex-col gap-y-5 justify-center items-center min-h-screen bg-primary text-secondary font-QuickSand">
      ...
      <div className="mx-auto max-w-lg w-full">
        <form className="w-full flex flex-col gap-y-2" onSubmit={registerHandling}>
          ...
          <button type="submit" className="border-[1px] mt-2 border-slate-600 bg-slate-400/20 rounded-[12px] py-2">
